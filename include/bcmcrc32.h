/* ------------------------------------------------------------------
 * BCM Crc32 - Shared Project Header
 * ------------------------------------------------------------------ */
...
#define bcm_MAGIC	0x30524448      /* "HDR0" */

/* structure based on openwrt docs and http://skaya.enix.org/wiki/FirmwareFormat */

struct bcm_header_v1
{
